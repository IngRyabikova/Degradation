...
void draw_text()
{   txSetColor (TX_WHITE);
    txDrawText(714,14,1239,108,"Цель - рассадить учеников так, чтобы\n класс получился максимально отсталым\n и вы открыли все 3 карты");
    txDrawText(844, 540, 1205, 600, "Чтобы сделать скриншот,\n нажмите Printscrin");
    txSetColor (TX_BLACK);
}
/// Рисование фона
...
int main()
{
    ...
    plans[2] = {625, 895, 750, 0, txLoadImage ("Картинки/Фоны/задний фон 2.bmp"), 7,
        {{100, 150},
         {100, 380},
         {100, 550},
         {280, 380},
    ...
    plans[1] = {630, 882, 800, 0, txLoadImage ("Картинки/Фоны/задний фон 3.bmp"), 28,
        {{50, 235},
         {114, 235},
         {256, 235},
         {315, 235},
    ...
    N_VARS = fillVariants("Картинки/Ученики/", variants, N_VARS, "Ученики");
    N_VARS = fillVariants("Картинки/Учителя/", variants, N_VARS, "Учителя");
